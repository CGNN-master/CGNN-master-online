...
(3) Note that the following comands consist of both training and evaluation, if you do not want to train Ours, you can directly download our trained models from:  
